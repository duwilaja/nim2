					...
					<div class="card">
						<div class="row row-sm">
							<div class="col-lg-6 col-xl-5 d-none d-lg-block text-center bg-primary details">
								<div class="mt-5 pt-4 p-2 pos-absolute" style="position:relative;">
									<img src="img/polri.svg" class="d-lg-none header-brand-img text-start float-start mb-4 error-logo-light" alt="logo">
									<img src="img/polri.svg" class=" d-lg-none header-brand-img text-start float-start mb-4 error-logo" alt="logo">
									<div class="clearfix"></div>
									<img src="img/polri.png" class="ht-200 mb-0" alt="user">
									<h5 class="mt-4 text-white hidden">Create Your Account</h5>
									<span class="tx-white-6 tx-13 mb-5 mt-xl-0 hidden">Signup to create, discover and connect with the global community</span>
								</div>
							</div>
								...
								<div class="main-container container-fluid">
									<div class="row row-sm">
										<div class="card-body mt-2 mb-2">
											<img src="img/polri.svg" class=" d-lg-none header-brand-img text-start float-start mb-4" alt="logo">
											<div class="clearfix"></div>
