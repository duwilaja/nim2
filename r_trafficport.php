					...
					<div class="card-body">
						<div class="row">
							...
							<div class="col-md-6"><div class="input-group">
								<select id="hos" class="form-control" onchange="getport(this.value);">
...
function  submit_r_trfc(){
	...
	var h=gethos(id);
	if(id!=''&&idx!=''&&h!=''){
		get_content("lib_traffic<?php echo $ext?>",{h:h,d:id,p:idx},".ldr-inter","#isi-inter");
		//$("#btnpdf").show();
	}
}
function getport(tv){
	getCombo('lib_dataget<?php echo $ext?>','ports',tv,'#ports','',blnk='--- Please Select ---');
}
